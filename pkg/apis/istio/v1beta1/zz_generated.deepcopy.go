...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PercentagePercent) DeepCopyInto(out *PercentagePercent) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PercentagePercent.
func (in *PercentagePercent) DeepCopy() *PercentagePercent {
	if in == nil {
		return nil
	}
	out := new(PercentagePercent)
