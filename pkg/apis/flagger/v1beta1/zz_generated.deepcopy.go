...
func (in *CanarySpec) DeepCopyInto(out *CanarySpec) {
	*out = *in
	...
	if in.StatefulRollout != nil {
		in, out := &in.StatefulRollout, &out.StatefulRollout
		*out = new(StatefulRollout)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StatefulRollout) DeepCopyInto(out *StatefulRollout) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StatefulRollout.
func (in *StatefulRollout) DeepCopy() *StatefulRollout {
	if in == nil {
		return nil
	}
	out := new(StatefulRollout)
