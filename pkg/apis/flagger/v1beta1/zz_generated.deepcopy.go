...
func (in *AutoscalerReference) DeepCopyInto(out *AutoscalerReference) {
	*out = *in
	...
	if in.PrimaryScalingSet != nil {
		in, out := &in.PrimaryScalingSet, &out.PrimaryScalingSet
		*out = new(ScalingSetRef)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CanaryInterceptorProxyService) DeepCopyInto(out *CanaryInterceptorProxyService) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CanaryInterceptorProxyService.
func (in *CanaryInterceptorProxyService) DeepCopy() *CanaryInterceptorProxyService {
	if in == nil {
		return nil
	}
	out := new(CanaryInterceptorProxyService)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomBackend) DeepCopyInto(out *CustomBackend) {
	*out = *in
	in.CustomMetadata.DeepCopyInto(&out.CustomMetadata)
	if in.BackendObjectReference != nil {
		in, out := &in.BackendObjectReference, &out.BackendObjectReference
		*out = new(gatewayapiv1.BackendObjectReference)
		(*in).DeepCopyInto(*out)
	}
	if in.Filters != nil {
		in, out := &in.Filters, &out.Filters
		*out = make([]gatewayapiv1.HTTPRouteFilter, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomBackend.
func (in *CustomBackend) DeepCopy() *CustomBackend {
	if in == nil {
		return nil
	}
	out := new(CustomBackend)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScalingSetRef) DeepCopyInto(out *ScalingSetRef) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScalingSetRef.
func (in *ScalingSetRef) DeepCopy() *ScalingSetRef {
	if in == nil {
		return nil
	}
	out := new(ScalingSetRef)
