	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GatewayapiV1beta1().ReferenceGrants(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayapiV1beta1().ReferenceGrants(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *referenceGrantInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&gatewayapiv1beta1.ReferenceGrant{}, f.defaultInformer)
}
