...
type ReferenceGrantInformer interface {
	...
	Lister() gatewayapiv1beta1.ReferenceGrantLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GatewayapiV1beta1().ReferenceGrants(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayapiV1beta1().ReferenceGrants(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayapiV1beta1().ReferenceGrants(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayapiV1beta1().ReferenceGrants(namespace).Watch(ctx, options)
			},
		},
		&apisgatewayapiv1beta1.ReferenceGrant{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *referenceGrantInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisgatewayapiv1beta1.ReferenceGrant{}, f.defaultInformer)
}

func (f *referenceGrantInformer) Lister() gatewayapiv1beta1.ReferenceGrantLister {
	return gatewayapiv1beta1.NewReferenceGrantLister(f.Informer().GetIndexer())
}
