...
type ReferenceGrantLister interface {
	...
	List(selector labels.Selector) (ret []*gatewayapiv1beta1.ReferenceGrant, err error)
...
type referenceGrantLister struct {
	listers.ResourceIndexer[*gatewayapiv1beta1.ReferenceGrant]
}
...
func NewReferenceGrantLister(indexer cache.Indexer) ReferenceGrantLister {
	return &referenceGrantLister{listers.New[*gatewayapiv1beta1.ReferenceGrant](indexer, gatewayapiv1beta1.Resource("referencegrant"))}
}

// ReferenceGrants returns an object that can list and get ReferenceGrants.
func (s *referenceGrantLister) ReferenceGrants(namespace string) ReferenceGrantNamespaceLister {
	return referenceGrantNamespaceLister{listers.NewNamespaced[*gatewayapiv1beta1.ReferenceGrant](s.ResourceIndexer, namespace)}
}
...
type ReferenceGrantNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*gatewayapiv1beta1.ReferenceGrant, error)
