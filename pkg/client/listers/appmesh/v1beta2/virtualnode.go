...
type VirtualNodeLister interface {
	...
	List(selector labels.Selector) (ret []*appmeshv1beta2.VirtualNode, err error)
...
type virtualNodeLister struct {
	listers.ResourceIndexer[*appmeshv1beta2.VirtualNode]
}

// NewVirtualNodeLister returns a new VirtualNodeLister.
func NewVirtualNodeLister(indexer cache.Indexer) VirtualNodeLister {
	return &virtualNodeLister{listers.New[*appmeshv1beta2.VirtualNode](indexer, appmeshv1beta2.Resource("virtualnode"))}
}

// VirtualNodes returns an object that can list and get VirtualNodes.
func (s *virtualNodeLister) VirtualNodes(namespace string) VirtualNodeNamespaceLister {
	return virtualNodeNamespaceLister{listers.NewNamespaced[*appmeshv1beta2.VirtualNode](s.ResourceIndexer, namespace)}
}
...
type VirtualNodeNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*appmeshv1beta2.VirtualNode, error)
