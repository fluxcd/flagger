...
type VirtualServiceLister interface {
	...
	List(selector labels.Selector) (ret []*appmeshv1beta1.VirtualService, err error)
...
type virtualServiceLister struct {
	listers.ResourceIndexer[*appmeshv1beta1.VirtualService]
}
...
func NewVirtualServiceLister(indexer cache.Indexer) VirtualServiceLister {
	return &virtualServiceLister{listers.New[*appmeshv1beta1.VirtualService](indexer, appmeshv1beta1.Resource("virtualservice"))}
}

// VirtualServices returns an object that can list and get VirtualServices.
func (s *virtualServiceLister) VirtualServices(namespace string) VirtualServiceNamespaceLister {
	return virtualServiceNamespaceLister{listers.NewNamespaced[*appmeshv1beta1.VirtualService](s.ResourceIndexer, namespace)}
}
