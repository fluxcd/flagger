...
func NewTrafficRouteLister(indexer cache.Indexer) TrafficRouteLister {
	return &trafficRouteLister{listers.New[*kumav1alpha1.TrafficRoute](indexer, kumav1alpha1.Resource("trafficroute"))}
}
