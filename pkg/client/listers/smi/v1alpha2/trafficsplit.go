...
type TrafficSplitLister interface {
	...
	List(selector labels.Selector) (ret []*smiv1alpha2.TrafficSplit, err error)
...
type trafficSplitLister struct {
	listers.ResourceIndexer[*smiv1alpha2.TrafficSplit]
}
...
func NewTrafficSplitLister(indexer cache.Indexer) TrafficSplitLister {
	return &trafficSplitLister{listers.New[*smiv1alpha2.TrafficSplit](indexer, smiv1alpha2.Resource("trafficsplit"))}
}

// TrafficSplits returns an object that can list and get TrafficSplits.
func (s *trafficSplitLister) TrafficSplits(namespace string) TrafficSplitNamespaceLister {
	return trafficSplitNamespaceLister{listers.NewNamespaced[*smiv1alpha2.TrafficSplit](s.ResourceIndexer, namespace)}
}
...
type TrafficSplitNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*smiv1alpha2.TrafficSplit, error)
