...
type TrafficSplitLister interface {
	...
	List(selector labels.Selector) (ret []*smiv1alpha1.TrafficSplit, err error)
...
type trafficSplitLister struct {
	listers.ResourceIndexer[*smiv1alpha1.TrafficSplit]
}
...
func NewTrafficSplitLister(indexer cache.Indexer) TrafficSplitLister {
	return &trafficSplitLister{listers.New[*smiv1alpha1.TrafficSplit](indexer, smiv1alpha1.Resource("trafficsplit"))}
}

// TrafficSplits returns an object that can list and get TrafficSplits.
func (s *trafficSplitLister) TrafficSplits(namespace string) TrafficSplitNamespaceLister {
	return trafficSplitNamespaceLister{listers.NewNamespaced[*smiv1alpha1.TrafficSplit](s.ResourceIndexer, namespace)}
}
...
type TrafficSplitNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*smiv1alpha1.TrafficSplit, error)
