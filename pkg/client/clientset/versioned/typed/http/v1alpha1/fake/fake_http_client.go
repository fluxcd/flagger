...
import (
	v1alpha1 "github.com/fluxcd/flagger/pkg/client/clientset/versioned/typed/http/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeHttpV1alpha1 struct {
	*testing.Fake
}
...
func (c *FakeHttpV1alpha1) RESTClient() rest.Interface {
